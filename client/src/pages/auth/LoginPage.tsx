...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(apiErr.response?.data?.message || 'Invalid email or password. Please try again.');
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden select-none">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-white font-display">Welcome back</h2>
          ...
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="#" className="text-xs text-brand-400 hover:text-brand-300 font-medium">
                  Forgot?
                </Link>
              </div>
              <input
